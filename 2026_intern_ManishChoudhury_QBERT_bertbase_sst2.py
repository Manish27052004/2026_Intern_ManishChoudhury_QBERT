...
# -*- coding: utf-8 -*-
"""
Q-BERT Quantization | BERT-Base × SST-2
File   : 2026_intern_ManishChoudhury_QBERT_bertbase_sst2.py
...
def main():
    ...
    pd.DataFrame([{
        "model":"bert-base-uncased","task":"sst2","checkpoint":CHECKPOINT,
