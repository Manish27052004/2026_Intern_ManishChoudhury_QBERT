...
# -*- coding: utf-8 -*-
"""
Q-BERT Quantization | ALBERT-Base-v2 × RTE
File   : 2026_intern_ManishChoudhury_QBERT_albert_rte.py
...
CHECKPOINT  = "anirudh21/albert-base-v2-finetuned-rte"
WEIGHT_BIT  = 8
MAX_LEN     = 128
RESULTS_CSV = "result_albert_rte.csv"
LATENCY_WARMUP, LATENCY_RUNS, LATENCY_BATCH = 20, 100, 32

DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")
print("="*60)
print("  Q-BERT | ALBERT-Base-v2 × RTE")
print("="*60)
...
def main():
    ...
    pd.DataFrame([{
        "model":"albert-base-v2","task":"rte","checkpoint":CHECKPOINT,
